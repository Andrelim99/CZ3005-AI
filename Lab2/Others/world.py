...
class World:
    ...
    def update_agent(self, action):
        ...
        if action == 'shoot':
            ...
            while coordinate_to_check[0] >= 0 and coordinate_to_check[0] <= self.size[1] - 1 and coordinate_to_check[
                1] >= 0 and coordinate_to_check[1] <= self.size[0] - 1:
        ...
        self.world[self.agent.position[1]][
            self.agent.position[0]].occupant = None  # Remove agent from previous location
